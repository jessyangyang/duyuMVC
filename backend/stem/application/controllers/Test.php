...
class TestController extends \Yaf\Controller_Abstract 
{
    ...
    public function testAction() 
    {
        ...
        print_r("include EPub");

        $book = new EPub();
        print_r("new EPub()");
        print_r("EPub version: " . EPub::VERSION);
        print_r("EPub Req. Zip version: " . EPub::REQ_ZIP_VERSION);
        print_r("Zip version: " . Zip::VERSION);
        print_r("getCurrentServerURL: " . $book->getCurrentServerURL());
        print_r("getCurrentPageURL..: " . $book->getCurrentPageURL());
        ...
        print_r("include EPubChapterSplitter.php");
        ...
        print_r("new EPubChapterSplitter()");
    ...
    public function test2Action()
    {
        ...
        // $log->print_f("include EPub");

        $book = new EPub();
        // $log->print_f("new EPub()");
        // $log->print_f("EPub version: " . EPub::VERSION);
        // $log->print_f("EPub Req. Zip version: " . EPub::REQ_ZIP_VERSION);
        // $log->print_f("Zip version: " . Zip::VERSION);
        // $log->print_f("getCurrentServerURL: " . $book->getCurrentServerURL());
        // $log->print_f("getCurrentPageURL..: " . $book->getCurrentPageURL());
        ...
        // $log->print_f("Build Chapters");

        // $log->print_f("Add Chapter 1");
        $book->addChapter("Chapter 1: Lorem ipsum", "Chapter001.html", $chapter1, true, EPub::EXTERNAL_REF_ADD);
        // $log->print_f("Add Chapter 2");
        $book->addChapter("Chapter 2: Vivamus bibendum massa", "Chapter002.html", $content_start . "<h1>Chapter 2</h1>\n" . $chapter2);
        // $log->print_f("Add Chapter 3");
        $book->addChapter("Chapter 3: Vivamus bibendum massa again", "Chapter003.html", $chapter3);

        // Autosplit a chapter:
        // $log->print_f("Add Chapter 4");
        $book->setSplitSize(15000); // For this test, we split at approx 15k. Default is 250000 had we left it alone.
        $book->addChapter("Chapter 4: Vivamus bibendum massa split", "Chapter004.html", $chapter4, true);
        ...
        // Still using Chapter 4, but as you can see, "Chapter 4" also contains a header for Chapter 5.
        // require_once 'EPubChapterSplitter.php';
        // $log->print_f("include EPubChapterSplitter.php");

        $splitter = new EPubChapterSplitter();
        $splitter->setSplitSize(15000); // For this test, we split at approx 15k. Default is 250000 had we left it alone.
        // $log->print_f("new EPubChapterSplitter()");
