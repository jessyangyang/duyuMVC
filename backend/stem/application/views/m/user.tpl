...
<form action="/m/user/register" method="POST" class="form-vertical" id="user">
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <div class="input-prepend">
            <span class="add-on">密码</span><input type="text" size="20" name="password" class="span3">
            </div>
        </div>
    </div>
    <div class="control-group">
    ...
    {elseif $action eq 'register'}
        ...
        <div class="controls">
            ...
            <input type="text" size="20" name="password" placeholder="设一个登录密码（不少于6位）" class="span3">
        </div>
        <div class="controls">
            <button class="btn btn-large" type="submit">登录</button>
        </div>
